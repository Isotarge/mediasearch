<template>
  <div id="recommendationPanel">
    Number of recommendations: <input type='number' min='1' step='1' v-model="numRecommendations" @change='searchMedia'>
...
export default {
  ...
  methods: {
    updateSearchSetting(categoryName, sliderName, sliderValue, ignore) {
      if (!Object.prototype.hasOwnProperty.call(this.currentSearchSettings, categoryName)) {
      ...
      this.searchMedia();
		...
		checkSingleStat(media, categoryName, sliderName) {
			if (Object.prototype.hasOwnProperty.call(media, categoryName)) {
				if (Object.prototype.hasOwnProperty.call(media[categoryName], sliderName)) {
					var difference = this.currentSearchSettings[categoryName][sliderName].value - media[categoryName][sliderName];
      ...
      if (Object.prototype.hasOwnProperty.call(this.currentSearchSettings, categoryName)) {
        if (Object.prototype.hasOwnProperty.call(this.currentSearchSettings[categoryName], sliderName)) {
          if (Object.prototype.hasOwnProperty.call(this.currentSearchSettings[categoryName][sliderName], "ignore")) {
			...
			matches.forEach(function(match) {
				if (numMatches < _this.numRecommendations) {
					...
					if (Object.prototype.hasOwnProperty.call(match[0], "link")) {
							matchString += "	<td><a href='" + match[0].link + "' target='_blank'>" + match[0].name + "</a></td>\n";
					} else {
